...
namespace HoloToolkit.Unity.SpatialMapping.Tests
{
    ...
    public class SpatialProcessingTest : Singleton<SpatialProcessingTest>
    {
        ...
        private void Start()
        {
            ...
            SpatialMappingManager.Instance.SetSurfaceMaterial(new Material[] { defaultMaterial });
        ...
        private void SurfaceMeshesToPlanes_MakePlanesComplete(object source, System.EventArgs args)
        {
            ...
            if (floors.Count >= minimumFloors)
            {
                ...
                SpatialMappingManager.Instance.SetSurfaceMaterial(new Material [] { secondaryMaterial });
            }
            else
            {
