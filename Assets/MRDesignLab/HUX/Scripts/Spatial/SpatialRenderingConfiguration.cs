    ...
    public RenderingState CurrentRenderingState
    {
        ...
        set
        {
            ...
            switch (value)
            {
                ...
                {
                    m_SpatialMappingManager.SurfaceMaterials = m_OcclusionMaterial;
                    m_SpatialUnderstandingCustomMesh.MeshMaterials = m_OcclusionMaterial;
                    break;
                }

                case RenderingState.DefaultMaterial:
                {
                    m_SpatialMappingManager.SurfaceMaterials = m_SpatialMappingDefaultMaterial;
                    m_SpatialUnderstandingCustomMesh.MeshMaterials = m_SpatialUnderstandingDefaultMaterial;
                    break;
                }

                case RenderingState.None:
                {
                    m_SpatialMappingManager.SurfaceMaterials = null;
                    m_SpatialMappingManager.DrawVisualMeshes = false;
                    m_SpatialUnderstandingCustomMesh.MeshMaterials = null;
